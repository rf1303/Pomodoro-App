...
function SettingsOptions({ onClose }) {
    const { color, timeLeft, setTimeLeft, font, setColor, mode, setMode, duration, setDuration, PomodoroOptions, setIsSettingOption, activeFont, setActiveFont } = useSettingsPerfil();
                    ...
                    <div className="w-full">
                        ...
                        <div className="w-full flex flex-col items-center justify-center gap-2">
                            {Object.keys(PomodoroOptions).map((option) => (
                                <div key={option} className="w-full flex items-center justify-between">
